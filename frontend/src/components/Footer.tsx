const Footer = () => {
  return (
    <footer className="border-t border-gray-200 dark:border-stone-700 bg-white dark:bg-stone-900 mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-stone-400">
              <li>
